      ...
      <div class="w-screen">
        <div class="flex flex-col space-y-3">
          ...
          <div class="flex items-center px-10">
            ...
            >
              <div class="m-1">
                <p class="p-2 text-xl font-medium text-black">
                  <strong class="px-5 text-2xl">{{ name }}</strong> 프로세스
                  정보
                </p>
              </div>
              <div>
              ...
              <div class="flex flex-col space-y-10">
                <div class="flex flex-col">
                  <div class="flex flex-col justify-center">
                    <div
                      class="inline-block w-auto py-2 space-y-4 sm:px-6 lg:px-8"
                    >
                      ...
                      <div class="flex justify-end">
                        <button
                          ...
                          type="button"
                          class="inline-block rounded bg-green-500 px-6 py-2.5 text-md font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-lg focus:bg-green-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-800 active:shadow-lg"
                        >
                          전형 추가
                        </button>
                      </div>
