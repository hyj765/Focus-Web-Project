...
const goCorporateHome = () => router.push({ name: 'Corporate' });
const goSheetEdit = () => router.push({ name: 'SheetEdit', params: { id } });
const goSheetCreate = () => router.push({ name: 'SheetCreate' });
</script>
