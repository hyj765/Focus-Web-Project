        ...
        >
          ...
          <div class="flex items-center space-x-2">
            <img
              ...
              alt="James Bhatta"
            />
            <button @click="moveToApplicantProfile()">
              <h4
...
const applicantSserId = ref('');

const BASE_URL = 'https://i8a106.p.ssafy.io/api';

const moveToApplicantProfile = () => {
...
const getApplicantInfo = () => {
  ...
  axios
    ...
    .then(res => {
      ...
      applicantName.value = applicantMyInfo.value.data.name;
      applicantEmail.value = applicantMyInfo.value.data.email;
      applicantTel.value = applicantMyInfo.value.data.tel;
      applicantSserId.value = applicantMyInfo.value.data.userId;
    });
};
